    ...
    extends TestCase
{
     ...
     */
    private static void checkConnectMethodAndValidateData()
    {
        Boolean isUsingAttach
            = (Boolean)
        ...
        failIfContainsNull(data[connectingTime.ordinal()]);
        failIfContainsNull(data[connectedTime.ordinal()]);
    }
     ...
     */
    private static void failIfContainsNull(Double[] array)
    {
     ...
     */
    private static void checkTime(TimeMeasurements s)
    {
    ...
    private static void checkThreshold(
        Double[] previousStepTimes, TimeMeasurements s)
    {
        Double[] difference
    ...
    /**
     * Returns the median from passed array. Sorts the array as a side-effect.
     ...
     * @param driver The web driver in which to execute.
     * @return true if ready and false if not.
     */
    private static Boolean isReadyToStart(WebDriver driver)
    {
     ...
     */
    private TimeMeasurements timeMeasurementToProcess;
